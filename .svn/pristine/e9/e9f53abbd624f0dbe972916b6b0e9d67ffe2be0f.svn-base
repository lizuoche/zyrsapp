...
//	
	...
	layer.confirm("确定新增吗111？", function() {
		var id = null;
...
//		}
		$.ajax({
			...
			data : {
				...
				"clothclass" : $("#clothclass").val(),
				"clothpart" : $("#clothpart").val(),
				"url" : $("#url").val(),
				"istrue" : $("#istrue").val(),
				"limitsize" : $("#limitsize").val(),
				"clothmodelfilename" : $("#clothmodelfilename").val(),
				"md5file" : $("#md5file").val(),
				"holdpart" : $("#holdpart").val(),
				"byholdpart" : $("#byholdpart").val(),
				"clothmodelsex" : $("#clothmodelsex").val()
