...
<script type="text/javascript" src="<%=basePath%>js/action/addTerrace.js"></script>
<%-- <script type="text/javascript" src="<%=basePath%>js/cloths/model.js"></script> --%>
...
<body>
	<div class="bodyPop">
			<table class="table">
				<tr>
					<td class="lable" ><span>模型编号：</span></td>
					<td >
						...
						<input type="text" required="required" id="terraceid" name=""terraceid"" /> 
						<label id="bomNameError"	style="width: 200px; text-align: left;"></label></td>
					</td>
				</tr>
				<tr>
					<td class="lable" ><span>适用平台中文名</span></td>
					<td >
						<input type="text" required="required" id="cnterracename" name="cnterracename"/> 
						<label id="brandNameENError" style="width: 200px; text-align: left;"></label>
					</td>
				</tr>
				<tr>
					<td class="lable"><span>适用平台英文名：</span></td>
					<td >
						<input type="text" required="required" id="engterracename"	name="engterracename"/> 
