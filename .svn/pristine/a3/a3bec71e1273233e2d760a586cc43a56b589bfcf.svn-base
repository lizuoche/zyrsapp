...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />中依睿昇APP后台管理中心</h1>
  </div>
  <div class="head-l">
...
<div class="leftnav">
  ...
  <h2><span class="icon-user"></span>基础数据维护</h2>
  <ul>
   <li><a href="jsp/cloths/terrace.jsp" target="right"><span class="icon-caret-right"></span>适用平台</a></li>
   <li><a href="jsp/cloths/model.jsp" target="right"><span class="icon-caret-right"></span>服装类型管理111</a></li>
   <li><a href="jsp/cloths/model.jsp" target="right"><span class="icon-caret-right"></span>服装部位</a></li>
   <li><a href="jsp/cloths/model.jsp" target="right"><span class="icon-caret-right"></span>男士服装模型</a></li>
   <li><a href="jsp/cloths/model.jsp" target="right"><span class="icon-caret-right"></span>女士服装模型</a></li>
   <li><a href="jsp/cloths/model.jsp" target="right"><span class="icon-caret-right"></span>通用服装模型</a></li>
   <li><a href="jsp/cloths/model.jsp" target="right"><span class="icon-caret-right"></span>配饰模型</a></li>
  </ul> 
  
  <h2><span class="icon-user"></span>数据字典管理</h2>
  <ul>
   <li><a href="jsp/cloths/dict.jsp" target="right"><span class="icon-caret-right"></span>数据字典</a></li>
  </ul> 
</div>
