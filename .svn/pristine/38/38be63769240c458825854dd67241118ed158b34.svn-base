...
<script type="text/javascript" src="<%=path%>/appjs/appcloth/clothmainmodel.js"></script>
			...
			<div class="padding border-bottom">
				<ul class="search">
					<li>
						...
						<button type="button" class="button border-green" onclick='clothMainModelToJson("cravat")'>
