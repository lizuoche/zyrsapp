...
<script type="text/javascript" src="<%=path%>/appjs/clothclass/updateclothclass.js"></script>
...
<body>
	<div class="bodyPop">
			<table class="table">
				...
				<tr>
					<td class="lable" ><span>类型性别：</span></td>
					<td>
						<select id="clothclasssex"  name="clothclasssex" style="width: 200px">
				...
				<tr>
					...
					<td >
					 ...
					 -->
					<td>
						<select id="clothclassistrue"  name="clothclassistrue" style="width: 200px">
