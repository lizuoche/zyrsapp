...
function doSearch() {
	$.ajax({
		type : "post",
		url : "clothpart/getAllClothPartById",
		data : {
			"id" : id,
		},
		dataType : "json",
		...
		success : function(data) {
			if (data.success) {
				...
				tbody.empty();
				var tabhtml = "";
					$("#clothpartcnname").val(res.clothpartcnname);
					$("#clothpartengname").val(res.clothpartengname);
					$("#clothpartstyle").val(res.clothpartstyle);
					$("#clothpartoccasion").val(res.clothpartoccasion);
					$("#clothpartclass").val(res.clothpartclass);
					$("#clothpartcode").val(res.clothpartcode);
