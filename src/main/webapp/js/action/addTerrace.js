...
//	
	...
	layer.confirm("确定新增吗1111111？", function() {
		var id = null;
...
//		}
		$.ajax({
			...
			url : "terraces/addTerraces",
			type : "post",
			dataType : "json",
			data : {
				"terraceid" : $("#terraceid").val(),
				"cnterracename" : $("#cnterracename").val(),
				"engterracename" : $("#engterracename").val()
			},
			async : false,
