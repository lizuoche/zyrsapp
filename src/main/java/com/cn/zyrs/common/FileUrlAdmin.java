...
public class FileUrlAdmin {
	...
	public static void MoveFolderAndFileWithSelf(String from, String to) throws Exception {
		System.out.println(from+"fffffffffffffffffffffffffffffffffffffffffffff");
		System.out.println(to+"fffffffffffffffffffffffffffffffffffffffffffff");
		try {
	...
	public static void main(String[] args) throws Exception {
		...
		FileUrlAdmin databean = new FileUrlAdmin();
		// File fl=new File("F:\\111\\222\\333\\444\\");
		// fl.mkdirs();//可以直接建立多级目录
		// databean.MoveFolderAndFileWithSelf("F:\\JBuilder 2006
		// 开发J2EE服务器应用程序.pdf","J:\\J\\");
		 databean.MoveFolderAndFileWithSelf("C:\\toclothjson\\","C:\\toclothjson\\IOS\\Suit.jpg");

//		databean.CopySingleFile("C:\\toclothjson\\Suit.jpg", "C:\\toclothjson\\IOS\\Suit.jpg");
//		databean.CopySingleFile("C:\\toclothjson\\Suit.jpg", "C:\\toclothjson\\Android\\Suit.jpg");
//		databean.CopySingleFile("C:\\toclothjson\\D1_PBL.assetbundle", "C:\\toclothjson\\IOS\\D1_PBL.assetbundle");
//		databean.CopySingleFile("C:\\toclothjson\\D1_PBL.assetbundle", "C:\\toclothjson\\Android\\D1_PBL.assetbundle");
